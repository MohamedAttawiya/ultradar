...
(function () {
  ...
  function activate(view, opts = {}){
    ...
    if (view === 'exclusions') {
      if (window.UltradarExclusions && typeof window.UltradarExclusions.activate === 'function') {
        window.UltradarExclusions.activate();
      }
    }
...
`;
  ...
  window.UltradarStrategies = Object.assign(window.UltradarStrategies || {}, {
    ...
    appendKnownStrategies,
    dedupeStrategySummaries,
